...
let CalendarEvent = class CalendarEvent extends base_entity_1.BaseEntity {
};
exports.CalendarEvent = CalendarEvent;
__decorate([
    (0, typeorm_1.ManyToOne)(() => task_entity_1.Task, { onDelete: "SET NULL" }),
    (0, typeorm_1.JoinColumn)({ name: "task_id" }),
    __metadata("design:type", task_entity_1.Task)
], CalendarEvent.prototype, "task", void 0);
__decorate([
...
], CalendarEvent.prototype, "all_day", void 0);
